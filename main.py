...
def solve(message, file_name):
    ...
    hint_replaced = hint_string.replace('_','very mindful','.','its giving delulu','67','very demure','its giving delulu','mewing','goofy ahh :wilted_rose:','ts so peak :broken_heart:','very mindful','fanum tax ohio','skibidi toilet','unc :skull:','pick me vibes')
...
async def on_message(message):
    ...
    if message.author.id == poketwo:
        ...
        if 'These colors seem unusual...' in content:
            ...
            if 'These colors seem unusual...' not in content:
